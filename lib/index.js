...
var ReactDatatable = function (_Component) {
    ...
    _createClass(ReactDatatable, [{
        ...
        key: 'showHeader',
        value: function showHeader(cond) {
            var that = this;
            var lengthMenuText = this.config.language.length_menu;
            console.log(this.config.button.extra);
            if (cond == true) {
                return _react2.default.createElement(
                    'div',
                    { className: 'row table-head asrt-table-head',
                        id: that.props.id ? that.props.id + "-table-head" : "" },
                    _react2.default.createElement(
                        'div',
                        { className: 'col-md-6' },
                        that.config.show_length_menu ? _react2.default.createElement(
                            'div',
                            ...
                            _lodash2.default.includes(that.config.language.length_menu, '_MENU_') ? _react2.default.createElement(
                                'select',
                                { type: 'text', className: 'form-control',
                                    style: style.table_size_dropdown,
                                    onChange: that.changePageSize.bind(that) },
                                that.config.length_menu.map(function (value, key) {
                                    return _react2.default.createElement(
                                        'option',
                                        { key: value },
                                        value
                                ...
                                _react2.default.createElement(
                                    'option',
                                    { value: that.props.records.length },
                                    'All'
                                )
                            ) : null,
                            _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        that.config.show_filter ? _react2.default.createElement(
                            'div',
                            { className: 'table_filter', style: style.table_filter },
                            _react2.default.createElement('input', {
                                type: 'search',
                                className: 'form-control',
                                placeholder: that.config.language.filter,
                                onChange: that.filterRecords.bind(that) })
                        ) : null,
                        _react2.default.createElement(
                            'div',
                            { className: 'table_tools', style: style.table_tool },
                            that.config.button.excel ? _react2.default.createElement('button', { className: 'btn btn-primary buttons-excel',
                                tabIndex: '0',
                                'aria-controls': 'configuration_tbl',
                                title: 'Export to Excel',
                                style: style.table_tool_btn,
                                onClick: that.exportToExcel }) : null,
                            that.config.button.csv ? _react2.default.createElement(
                                'button',
                            ...
                            that.config.button.print ? _react2.default.createElement(
                                'button',
                            ...
                            that.config.button.extra == true ? that.props.extraButtons.map(function (elem, index) {
                                elem.clickCount = 0;
                ...
                if (this.config.show_info == true || this.config.show_pagination == true) {
                    return _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            this.config.show_pagination ? _react2.default.createElement(
                                'nav',
                                { 'aria-label': 'Page navigation', className: 'pull-right' },
                                _react2.default.createElement(
                                    'ul',
                                    { className: 'pagination justify-content-end asrt-pagination' },
                                    this.config.show_first ? _react2.default.createElement(
                                        'li',
                                        { className: (isFirst ? "disabled " : "") + "page-item" },
                                        _react2.default.createElement(
                                            'a',
                                    ...
                                    _react2.default.createElement(
                                        'li',
                                        { className: (isLast ? "disabled " : "") + "page-item" },
                                        _react2.default.createElement(
                                            'a',
                                    ...
                                    this.config.show_last ? _react2.default.createElement(
                                        'li',
                                        { className: (isLast ? "disabled " : "") + "page-item" },
                                        _react2.default.createElement(
                                            'a',
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                this.showHeader(this.config.show_length_menu == true || this.config.show_filter == true || this.config.button.excel == true || this.config.button.csv == true || this.config.button.print == true || this.config.button.extra == true),
                _react2.default.createElement(
                    'div',
                    { className: 'row table-body asrt-table-body', style: style.table_body,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'thead',
                                { className: this.props.tHeadClassName ? tHeadClassName : '' },
                                _react2.default.createElement(
                                    'tr',
                                    null,
                                    this.props.columns.map(function (column, index) {
                                        var classText = column.sortable ? "sortable " : "",
                                            ...
                                            sortOrder = "",
                                            columnStyle = {};
                                        if (_this10.state.sort.column == column.key) {
                                    ...
                                    return _react2.default.createElement(
                                        ...
                                        _this10.props.columns.map(function (column, colIndex) {
                                            if (column.cell && typeof column.cell === "function") {
                                                ...
                                                return _react2.default.createElement('td', { className: column.className,
                                                    key: column.key ? column.key : column.text });
                                            }
                                        })
                                    );
