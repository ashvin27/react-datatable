  ...
  _createClass(ReactDatatable, [{
    ...
    value: function render() {
      ...
      if (this.props.dynamic === false) {
        var records = _lodash2.default.orderBy(this.props.records, [this.state.sort.column], [this.state.sort.order]),
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'row table-foot asrt-table-foot', id: this.props.id ? this.props.id + "-table-foot" : "" },
          _react2.default.createElement(
            'div',
            { className: 'col-md-6' },
