...
class ReactDatatable extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      page_number: 1,
      sort: (config.sort) ? props.config.sort : false
    };
  }
...
const ReactDatatable = ({id, className, cloumns, config, dynamic, records,total_record, onChange, onPageChange, onRowClicked}) => {
